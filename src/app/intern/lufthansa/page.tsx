      ...
      <section className="py-12 px-4 sm:px-6 bg-white">
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="rounded-2xl bg-white border border-slate-200 p-6 md:p-8 shadow-sm">
            <h2 className="text-slate-900 font-bold text-xl mb-4">루프트한자 인턴십 소개</h2>
          ...
          <div className="rounded-2xl border border-sky-200 bg-sky-50 p-8 text-center">
            <div className="w-14 h-14 rounded-full bg-white border border-sky-200 flex items-center justify-center mx-auto mb-5 shadow-sm">
              <svg className="w-7 h-7 text-sky-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="text-slate-900 font-bold text-xl mb-2">상세 내용 준비 중</h3>
          ...
          <div className="rounded-2xl bg-white border border-slate-200 p-6 text-center shadow-sm">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <a href="tel:025683111" className="flex items-center gap-2 px-5 py-2.5 bg-sky-50 border border-sky-200 text-sky-700 text-sm rounded-xl hover:bg-sky-100 transition-colors">02-568-3111</a>
              <a href="https://pf.kakao.com/_hh6900" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 px-5 py-2.5 bg-yellow-400 hover:bg-yellow-300 text-slate-900 text-sm rounded-xl font-medium transition-colors">카카오톡 @hh6900</a>
            </div>
          </div>
        </div>
      </section>
