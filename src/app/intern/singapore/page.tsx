        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="rounded-2xl bg-white border border-slate-200 p-6 md:p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-xl bg-sky-50 border border-sky-200 flex items-center justify-center text-sky-700 font-bold text-xs shrink-0">SIA</div>
              <div>
                <h2 className="text-slate-900 font-bold text-xl">SIAEP</h2>
                <p className="text-slate-400 text-sm">Singapore Airlines Engineering Pte Ltd</p>
              </div>
            </div>
            <p className="text-slate-600 text-sm leading-relaxed mb-5">
              싱가폴항공 엔지니어링(SIAEP)은 2008년 설립된 아시아 최고 수준의 MRO 전문 업체입니다.
              필리핀 클락에 위치하며, <strong className="text-slate-900">EASA 145-MRO 인증</strong>을 보유한 아시아 13개국 중 유일한 EASA 교육기관입니다.
            </p>
          ...
          <div className="rounded-2xl bg-white border border-slate-200 p-6 md:p-8 shadow-sm">
            <h2 className="text-slate-900 font-bold text-xl mb-5">시설 규모</h2>
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                ...
                <div key={hangar.no} className="rounded-xl bg-slate-50 border border-slate-200 p-4 text-center">
          ...
          <div className="rounded-2xl bg-white border border-slate-200 p-6 md:p-8 shadow-sm">
            <h2 className="text-slate-900 font-bold text-xl mb-5">SLAEP 프로그램 목표</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={item.num} className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-lg bg-sky-50 border border-sky-200 flex items-center justify-center text-sky-700 text-xs font-bold shrink-0">{item.num}</div>
                  <div>
          ...
          <div>
            <h2 className="text-slate-900 font-bold text-xl mb-2">MTP 교육과정</h2>
            <p className="text-slate-400 text-sm mb-5">Maintenance Training Program</p>
            <div className="grid md:grid-cols-3 gap-4">
              {mtpCourses.map((course) => (
                <div key={course.name} className="rounded-2xl bg-white border border-slate-200 p-5 shadow-sm hover:border-sky-200 hover:shadow-md transition-all">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-slate-900 font-bold text-sm">{course.name}</h3>
            ...
            <div className="mt-4 rounded-xl bg-sky-50 border border-sky-200 p-4 text-center">
              <span className="text-slate-600 text-sm">총 교육 기간: <strong className="text-sky-600">약 267일</strong> (기체동력장치 115일 + 항공전자 107일 + 생산관리 45일)</span>
            </div>
          </div>
        </div>
      </section>
