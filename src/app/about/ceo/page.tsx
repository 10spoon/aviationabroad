        ...
        <div className="max-w-4xl mx-auto">
          <div className="rounded-2xl bg-white border border-slate-200 p-8 md:p-12 shadow-sm">
            ...
            <div className="space-y-6 text-slate-600 text-base leading-relaxed">
              <p>
                안녕하십니까.<br />
                항공유학 인사이트엣지 대표이사 <strong className="text-slate-900">허헌</strong>입니다.
              </p>
              <p>
                저희 인사이트엣지는 <strong className="text-sky-600">항공정비사, 항공조종사, 승무원</strong> 유학생을 모집하고,
                최고 수준의 항공유학 프로그램을 제공하기 위해 설립되었습니다.
              </p>
              <p>
                필리핀 클락에 위치한 <strong className="text-slate-900">Jocson College</strong>와의 MOA 협정을 통해
              ...
              <p>
                <strong className="text-slate-900">나의 꿈에 비상의 날개를 달아라!</strong><br />
            ...
            <div className="mt-10 pt-8 border-t border-slate-200 flex items-center gap-4">
              ...
              <div>
                <div className="text-slate-900 font-bold">허 헌</div>
                <div className="text-slate-500 text-sm">(주)인사이트엣지 대표이사</div>
              </div>
            </div>
          </div>
        </div>
