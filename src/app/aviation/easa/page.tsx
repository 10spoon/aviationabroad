      ...
      <section className="py-12 px-4 sm:px-6 bg-white">
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="rounded-2xl bg-white border border-slate-200 p-6 md:p-8 shadow-sm">
            <h2 className="text-slate-900 font-bold text-xl mb-4">EASA란?</h2>
            <p className="text-slate-600 text-sm leading-relaxed mb-4">
              <strong className="text-slate-900">EASA(European Aviation Safety Agency)</strong>는 2003년 9월 28일 설립된
              유럽항공안전기구로, 항공 안전 및 환경 보호를 위한 유럽연합의 규정을 제정하고 시행합니다.
            </p>
            <p className="text-slate-600 text-sm leading-relaxed">
              EASA Part-66 자격증은 현재 전 세계에서 가장 영향력 있는 항공정비사 자격증으로,
              <strong className="text-sky-600"> 175개국 이상</strong>에서 통용됩니다.
            </p>
          </div>

          <div>
            <h2 className="text-slate-900 font-bold text-xl mb-5">자격증 종류</h2>
            <div className="grid sm:grid-cols-2 gap-4">
              {certTypes.map((cert) => (
                <div key={cert.code} className="rounded-2xl bg-white border border-slate-200 p-5 shadow-sm hover:border-sky-200 hover:shadow-md transition-all">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 rounded-xl bg-sky-50 border border-sky-200 flex items-center justify-center text-sky-700 font-bold text-sm">
                      {cert.code}
                    </div>
                    <div className="text-slate-900 font-semibold text-sm">{cert.name}</div>
                  </div>
          ...
          <div className="rounded-2xl bg-white border border-slate-200 p-6 md:p-8 shadow-sm">
            <h2 className="text-slate-900 font-bold text-xl mb-5">시험 정보</h2>
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                ...
                <div key={item.label} className="rounded-xl bg-slate-50 border border-slate-200 p-4 text-center">
          ...
          <div className="rounded-2xl bg-white border border-slate-200 p-6 md:p-8 shadow-sm">
            <h2 className="text-slate-900 font-bold text-xl mb-5">경력 요건</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-slate-100">
                  <tr>
                    <td className="py-3 pr-4 text-sky-600 font-medium">CAT A</td>
                    <td className="py-3 pr-4 text-slate-600">3년</td>
                    <td className="py-3 pr-4 text-slate-600">2년</td>
                    <td className="py-3 text-slate-600">1년</td>
                  </tr>
                  <tr>
                    <td className="py-3 pr-4 text-sky-600 font-medium">CAT B</td>
                    <td className="py-3 pr-4 text-slate-600">4~5년</td>
                    <td className="py-3 pr-4 text-slate-600">3~4년</td>
                    <td className="py-3 text-slate-600">2~3년</td>
                  </tr>
                  <tr>
                    <td className="py-3 pr-4 text-sky-600 font-medium">CAT C</td>
                    <td className="py-3 pr-4 text-slate-400" colSpan={3}>B1 또는 B2 자격 취득 후 항공사 정비 3년 경력</td>
                  </tr>
                </tbody>
              </table>
            </div>
